    ...
    pages: [ // 一个事件由若干页面组成
        {
            ...
            image: "新生舞会/舞会培训.jpg",
            text: [ // 每个字符串代表一个自然段
                "某辅导员似乎说过，新生舞会是男生在大学期间唯一可以牵到女生的手的机会。",
                "马上要到舞会了，你选择："
            ],
            choices: [
                {
                    ...
                    actions: [ // 选择选项带来的影响
                        eq("#性别", "男").then(jump("invite_boy")).else(jump("invite_girl"))
                    ]
                },
                {
                    text: eq("#性别", "男").then(
                    ...
                    actions: [
                        eq("#性别", "男").then(jump("roommate")).else(jump("wait"))
                    ]
                },
                {
                    text: "算了，还是呆在寝室里吧",
        ...
        },
        {
            ...
            actions: [ // 页面影响会在选项影响之后执行
                jump("dance_boy") // 注意：如果选项中有 jump ，会忽略页面的 jump
            ]
        },
        {
            id: "invite_girl",
            text: [
                "他答应了！你觉得自己在脱单的道路上向前迈出了历史性的第一步。",
                "今晚就是舞会了，出门之前，你准备如何打扮自己？"
            ],
            choices: [
                {
                    text: "化一个精致的妆，穿上漂亮的裙子和高跟鞋",
                    actions: [
                        increase("#魅力", 2),
                        increase("$魅力", 2),
                        flag("$高跟鞋")
        ...
        },
        {
            id: "wait",
            text: [
                "可惜，你高估了系里男生的主动程度……于是你只好独自汽车来到舞会现场。",
                "好在现场还有配对的活动，你成功找到了一名男生作为舞伴。"
            ],
            actions: [
                jump("dance_girl")
            ]
        ...
        },
        {
            ...
            text: [
                "最简单的交谊舞就是在地上画三角形。",
                flagged("$高跟鞋").then([
                    "一嗒嗒、二嗒嗒、三嗒嗒。你们在舞池中跳了一支舞，你非常紧张，生怕没站稳崴了脚，一直低头注意着自己的步伐。"
                ]).else([
                    "一嗒嗒、二嗒嗒、三嗒嗒。你们在舞池中跳了一支舞，你非常紧张，生怕跳错，一直低头注意着自己的步伐。",
                ]),
                "曲终，你跳得非常完美。你对自己感到非常满意，但他似乎不是很开心的样子。下一支曲子就要开始了，于是你："
            ],
            choices: [
                {
                    text: "觉得有点累了，提议休息一会"
        ...
        },
        {
            ...
            actionsBefore: [ // 在载入页面时即执行的动作
                ge("$魅力", 3).then(achieve("月色真美")) // 满足条件则解锁成就
            ],
            text: [
