...
({
    ...
    pages: [
        ...
        },
        {
            id: "project1",
            text: [
                "人生当然应该来点挑战了。于是你义无反顾地选择了怼大作业。",
                "向勇说：想要做操统大作业，必须在前4周完成8个lab。",
                "没办法，只好爆肝一波了。"
            ],
            actions: [
                jump("project1_qte")
        ...
        },
        {
            ...
            //image: "TODO.jpg",
            text: [
                "十分不幸，你还是没能在4周内怼完8个lab。于是你只好悻悻然参加考试了。",
                "你选择："
            ],
            choices: [
                {
        ...
        },
        {
            id: "project2",
            text: [
                "第十三周就要交大作业了。每周例会上，陈渝向勇催促的语气也越来越重。",
